	...
	if (display != NULL) {
		...
		if (resm != NULL) {
			...
			if (xrdb != NULL) {
				...
				XRDB_LOAD_COLOR("dwm.color1", titlenormfloatcolor);
				XRDB_LOAD_COLOR("dwm.color3", titleselfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", titleselbgcolor);
				XRDB_LOAD_COLOR("dwm.color3", titleselbordercolor);
				XRDB_LOAD_COLOR("dwm.color3", titleselfloatcolor);
				XRDB_LOAD_COLOR("dwm.color5", tagsnormfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tagsnormbgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tagsnormbordercolor);
				XRDB_LOAD_COLOR("dwm.color1", tagsnormfloatcolor);
				XRDB_LOAD_COLOR("dwm.color3", tagsselfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tagsselbgcolor);
				XRDB_LOAD_COLOR("dwm.color3", tagsselbordercolor);
				XRDB_LOAD_COLOR("dwm.color3", tagsselfloatcolor);
				...
				XRDB_LOAD_COLOR("dwm.color1", hidselbgcolor);
				XRDB_LOAD_COLOR("dwm.color5", urgfgcolor);
				XRDB_LOAD_COLOR("dwm.color5", urgbgcolor);
				XRDB_LOAD_COLOR("dwm.color5", urgbordercolor);
				XRDB_LOAD_COLOR("dwm.color5", urgfloatcolor);
